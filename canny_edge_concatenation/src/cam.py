...
if __name__ == "__main__":
    ...
    parser.add_argument("image_type", help="baseline_original_images, baseline_gaussian_blur, baseline_fgsm_attack, baseline_pgd_attack,de-gaussian_blur,de-fgsm_attack,de-pgd_attack,de-fgsm_attack_light,de-pgd_attack_light,de-gaussian_blur_light")
    args = parser.parse_args()
    list_operations = ["test","baseline_original_images","baseline_gaussian_blur","baseline_fgsm_attack","baseline_pgd_attack", "de-gaussian_blur","de-fgsm_attack","de-pgd_attack","de-fgsm_attack_light","de-pgd_attack_light","de-gaussian_blur_light"]
